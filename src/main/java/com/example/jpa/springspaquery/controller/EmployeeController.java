package com.example.jpa.springspaquery.controller;

import com.example.jpa.springspaquery.model.Employee;
import com.example.jpa.springspaquery.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    public List<Employee> findByFirstNamewithIndex(@PathVariable("firstname") String firstname,
    ...
    public List<Employee> findByLastNamewithIndex(@PathVariable("lastname") String lastname,
                                                   @PathVariable("department") String department){
